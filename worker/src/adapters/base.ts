import type { WireAttachment, WireMessage } from "../types";
 ...
 */
export function formatOpenAIMessages(messages: WireMessage[], visionCapable: boolean): Array<{
        ...
        while (true) {
          ...
          while ((newlineIndex = buffer.indexOf("\n")) !== -1) {
            ...
            try {
              ...
              reasoningBuffer += extractDeltaReasoning(upstreamDelta);
