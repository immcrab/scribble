...
import { LogOut, Mail, Trash2, AlertTriangle, Loader2, Sparkles } from "lucide-react";
...
/** Signed-out state: Google is the only sign-in method. */
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-slate-500">
          Used for Puter.js models (Claude, GPT via Puter) — separate account and billing from Lofin.
        </p>
      </div>
      ...
      <div>
        ...
        >
          ...
          <span className="min-w-0 flex-1">
            ...
            <span className="block text-xs text-slate-500">support@lofin.dev</span>
          </span>
        </a>
      </div>
