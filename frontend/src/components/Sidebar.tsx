...
export function Sidebar({ onOpenSettings }: { onOpenSettings: () => void }) {
  ...
  return (
    <div
      className={`relative h-full shrink-0 border-r border-base-700/60 glass-panel transition-[width] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] ${
